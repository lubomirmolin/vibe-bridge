...
mod tests {
    ...
    #[tokio::test]
    async fn bridge_turn_metadata_merge_preserves_snapshot_item_order() {
        let state = test_bridge_app_state().await;
        let thread_id = "codex:thread-1";

        state
            .record_bridge_turn_metadata(&BridgeEventEnvelope {
                contract_version: CONTRACT_VERSION.to_string(),
                event_id: "codex:thread-1-status-turn-started".to_string(),
                thread_id: thread_id.to_string(),
                kind: BridgeEventKind::ThreadStatusChanged,
                occurred_at: "2026-04-09T05:45:44.296526+00:00".to_string(),
                payload: json!({
                    "status": "running",
                    "reason": "turn_started",
                }),
        ...
        let mut snapshot = ThreadSnapshotDto {
            ...
            thread: ThreadDetailDto {
                ...
                repository: "repo".to_string(),
                branch: "main".to_string(),
                created_at: "2026-04-09T05:40:00Z".to_string(),
                updated_at: "2026-04-09T05:46:14Z".to_string(),
                source: "codex_app_ipc".to_string(),
                access_mode: shared_contracts::AccessMode::ControlWithApprovals,
            ...
            entries: vec![
                ThreadTimelineEntryDto {
                    event_id: "019d70c6-6867-7693-971f-0152b3215ac7-item-9".to_string(),
                    kind: BridgeEventKind::MessageDelta,
                    occurred_at: "2026-04-09T05:45:44.295Z".to_string(),
                    summary: "What was it doing?".to_string(),
                    payload: json!({
                        "type": "userMessage",
                        "role": "user",
                        "text": "What was it doing?",
                    }),
                    annotations: None,
                },
                ThreadTimelineEntryDto {
                    event_id: "019d70c6-6867-7693-971f-0152b3215ac7-item-10".to_string(),
                    kind: BridgeEventKind::MessageDelta,
                    occurred_at: "2026-04-09T05:45:44.295Z".to_string(),
                    summary: "I'm reading the rest".to_string(),
                    payload: json!({
                        "type": "agentMessage",
                        "text": "I'm reading the rest",
                    }),
                    annotations: None,
                },
                ThreadTimelineEntryDto {
                    event_id: "019d70c6-6867-7693-971f-0152b3215ac7-item-11".to_string(),
                    kind: BridgeEventKind::MessageDelta,
                    occurred_at: "2026-04-09T05:45:44.295Z".to_string(),
                    summary: "It was meant to hold...".to_string(),
                    payload: json!({
                        "type": "agentMessage",
                        "text": "It was meant to hold...",
                    }),
                    annotations: None,
                },
            ],
        ...
        assert_eq!(
            event_ids,
            vec![
                "019d70c6-6867-7693-971f-0152b3215ac7-item-9",
                "019d70c6-6867-7693-971f-0152b3215ac7-item-10",
                "019d70c6-6867-7693-971f-0152b3215ac7-item-11",
                "codex:thread-1-status-turn-started",
            ]
        );
    }
