...
pub(super) fn extract_generated_thread_title(agent_message: Option<&str>) -> Option<String> {
    ...
    super::codex::normalize_generated_thread_title(raw_title)
}
...
pub(super) fn derive_repository_name_from_path(path: &str) -> Option<String> {
    Path::new(path)
        .file_name()
...
pub(super) fn payload_primary_text(payload: &Value) -> Option<&str> {
