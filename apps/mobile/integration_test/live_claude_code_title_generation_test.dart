...
Future<void> _requireAndroidLoopbackDevice(String bridgeApiBaseUrl) async {
  if (!Platform.isAndroid) {
    fail(
      ...
      'Run it with `flutter drive --driver=test_driver/integration_test.dart --target=integration_test/live_claude_code_title_generation_test.dart -d <android-device-id>`.',
    );
  }
